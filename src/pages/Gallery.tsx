        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <div className="animate-fade-in">
            ...
            <h1 className="text-6xl md:text-8xl font-montserrat font-black text-[#173d26] leading-tight mb-8">
              <span className="bg-gradient-to-r from-[#efe0bf] to-[#f0c515] bg-clip-text text-transparent">Masterful</span>
              <br />
            ...
            <Button 
              ...
              className="bg-gradient-to-r from-[#efe0bf] to-[#f0c515] text-[#173d26] hover:from-[#f0c515] hover:to-[#efe0bf] font-montserrat font-bold text-lg px-10 py-4 rounded-2xl transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl"
            >
              Book Your Session
            </Button>
          </div>
              ...
              <button
                ...
                className={`flex items-center px-6 py-3 rounded-2xl font-montserrat font-semibold transition-all duration-300 ${
                  selectedCategory === category.id
                    ? 'bg-[#173d26] text-white shadow-lg scale-105'
                    : 'bg-white text-[#173d26] hover:bg-[#173d26]/10 hover:text-[#173d26] shadow-md hover:shadow-lg hover:scale-105 border border-[#173d26]/20'
                }`}
              >
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {filteredImages.map((image, index) => (
              <Card 
                key={image.id} 
                className="group bg-white border-[#173d26]/10 shadow-lg hover:shadow-2xl transition-all duration-500 hover:scale-105 hover:-translate-y-2 overflow-hidden animate-scale-in"
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <h2 className="text-5xl md:text-6xl font-montserrat font-bold mb-8 text-[#173d26]">
              Become Part of Our 
              <br />
              <span className="bg-gradient-to-r from-[#efe0bf] to-[#f0c515] bg-clip-text text-transparent">Gallery</span>
            </h2>
            ...
            <Button 
              onClick={handleBookNow}
              className="bg-gradient-to-r from-[#efe0bf] to-[#f0c515] text-[#173d26] hover:from-[#f0c515] hover:to-[#efe0bf] font-montserrat font-bold text-xl px-12 py-6 rounded-2xl transition-all duration-300 hover:scale-105 shadow-lg"
            >
