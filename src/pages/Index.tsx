          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8">
            {premiumServices.map((service, index) => <Card key={service.title} className="bg-white shadow-xl hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 overflow-hidden rounded-2xl border border-[#173d26]/10">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="bg-gradient-to-r from-[#efe0bf] to-[#f0c515] bg-clip-text text-transparent font-montserrat font-bold text-xl mb-4 bg-slate-950">
                    {service.price}
                  </div>
                  ...
                  <Button onClick={handleBookNow} className="w-full bg-gradient-to-r from-[#efe0bf] to-[#f0c515] text-[#173d26] hover:from-[#f0c515] hover:to-[#efe0bf] transition-all duration-300 rounded-xl py-3 font-semibold shadow-lg hover:shadow-xl bg-[#173d26]">
                    Select Service
