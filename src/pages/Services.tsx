...
const Services = () => {
  ...
  const additionalServices = [
    { name: 'Hair Wash & Blow Dry', price: 60, icon: Sparkles },
    { name: 'Eyebrow Trimming', price: 40, icon: Scissors },
    { name: 'Hot Towel Treatment', price: 50, icon: Heart },
    { name: 'Scalp Treatment', price: 80, icon: Crown }
  ];
                      ...
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <div className="text-right">
                          <div className="flex items-center gap-2">
                            ...
                            {pkg.originalPrice && (
                              <span className="text-sm text-gray-400 line-through">{pkg.originalPrice} Birr</span>
                            )}
                          </div>
                        </div>
                      </div>
                ...
                <Card className="border-0 shadow-md p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Summit Feyel Bet<br/>Addis Ababa, Ethiopia</p>
                    </div>
                  </div>
                </Card>
                ...
                <Card className="border-0 shadow-md p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-xl font-bold">0935652525</p>
                ...
                <Card className="border-0 shadow-md p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Monday - Friday: 9:00 AM - 8:00 PM<br/>Saturday - Sunday: 8:00 AM - 6:00 PM</p>
                    </div>
                  </div>
                </Card>
              </div>
