  ...
  return <footer className="bg-obsidian text-gold py-16">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-3 mb-6">
              <img src="/lovable-uploads/fb01ca19-0340-4e03-8f65-cf04865664d6.png" alt="The Art Barbershop Logo" className="w-16 h-16 object-contain" />
            ...
            <div className="flex space-x-4">
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-forest rounded-full flex items-center justify-center hover:bg-gold hover:text-forest transition-colors duration-300 cursor-pointer group">
                <Facebook className="h-6 w-6 text-gold group-hover:text-forest transition-colors duration-300" />
              </a>
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-forest rounded-full flex items-center justify-center hover:bg-gold hover:text-forest transition-colors duration-300 cursor-pointer group">
                <Instagram className="h-6 w-6 text-gold group-hover:text-forest transition-colors duration-300" />
              </a>
              <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-forest rounded-full flex items-center justify-center hover:bg-gold hover:text-forest transition-colors duration-300 cursor-pointer group">
              ...
              <a href="https://telegram.org" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-forest rounded-full flex items-center justify-center hover:bg-gold hover:text-forest transition-colors duration-300 cursor-pointer group">
                <svg className="h-6 w-6 text-gold group-hover:text-forest transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 font-montserrat text-sm mb-4 md:mb-0">© 2025 The Art Barbershop. All rights reserved.</p>
